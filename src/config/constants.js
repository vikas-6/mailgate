...
module.exports = {
  ...
  ROLE_USERNAMES: new Set([
    ...
    'postmaster', 'billing', 'help', 'jobs', 'privacy', 'security',
    'abuse', 'no-reply', 'noreply', 'test', 'dev', 'marketing', 'office',
    'team', 'hello', 'general', 'feedback', 'press', 'legal', 'compliance'
  ]),
  ...
  FREE_WEBMAIL_DOMAINS: new Set([
    ...
    'mail.com', 'yandex.com', 'live.com', 'msn.com', 'me.com', 'google.com'
  ]),

  // Common Typo-Squatted Domains
  TYPO_DOMAINS: new Set([
    'doogle.com', 'gmaill.com', 'gamil.com', 'gmal.com', 'gmaik.com',
    'yaho.com', 'yahou.com', 'yahoof.com', 'hotmial.com', 'hotmai.com',
    'outluk.com', 'outloo.com', 'icloude.com', 'protonmai.com', 'zohomail.com'
  ])
};
